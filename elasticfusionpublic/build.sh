...
sudo apt-get install -y cmake-qt-gui git build-essential libusb-1.0-0-dev libudev-dev 
openjdk-7-jdk #default-jdk 
freeglut3-dev libglew-dev libsuitesparse-dev libeigen3-dev zlib1g-dev libjpeg-dev #libopenexr-dev

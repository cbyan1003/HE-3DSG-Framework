...
class GPUConfig
{
    ...
    private:
           ...
           so3StepBlocks(64)
        {
            ...
            icpStepMap["NVIDIA GeForce RTX 2080 Ti"] = std::pair<int, int>(144, 144);
            rgbStepMap["NVIDIA GeForce RTX 2080 Ti"] = std::pair<int, int>(144, 144);
            rgbResMap["NVIDIA GeForce RTX 2080 Ti"] = std::pair<int, int>(256, 256);
            so3StepMap["NVIDIA GeForce RTX 2080 Ti"] = std::pair<int, int>(144, 144);

            icpStepMap["NVIDIA GeForce RTX 3090"] = std::pair<int, int>(320, 128);
            rgbStepMap["NVIDIA GeForce RTX 3090"] = std::pair<int, int>(368, 64);
            rgbResMap["NVIDIA GeForce RTX 3090"] = std::pair<int, int>(448, 256);
            so3StepMap["NVIDIA GeForce RTX 3090"] = std::pair<int, int>(16, 144);

...
#ifndef UTILDATAPROCESSING_H
#define UTILDATAPROCESSING_H
    ...
    public:
        ...
        static MemoryBlock2D compute_edge_descriptor(
            ...
            for(size_t i=0;i<n_edge;++i){
                ...
                auto idx_i = edge_index.at<int64_t>(0, i);
                auto idx_j = edge_index.at<int64_t>(1, i);

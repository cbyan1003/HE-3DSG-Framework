...
public:
	...
	void saveInstancePointCloud(const std::unique_ptr<ElasticFusionInterface>& map,int num);
	void getInstancePointCloud(const std::unique_ptr<ElasticFusionInterface>& map,bool bboxType);
	void getPointCloud(const std::unique_ptr<ElasticFusionInterface>& map,int num);
	...
	std::vector<float> getFeatureMap(int index);
	std::vector<int> getColorMap(int index);
	std::vector<int> getInstanceColor(int index);
...
protected:
	...
	std::map<int,std::vector<int>> Instancecolor;

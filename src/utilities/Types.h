...
struct NodeList {
  NodeList() 
  : all_node(0), real_node(0), no_use_node(0) {}
  NodeList(int all_node_, int real_node_, int no_use_node_) 
  : all_node(all_node_), real_node(real_node_), no_use_node(no_use_node_) {}
  int all_node, real_node, no_use_node;
};
#endif /* TYPES_H_ */
